...
- Efectuar una auditoría integral y determinar la situación económica y financiera real del Banco Minero de Bolivia al 31 de diciembre de 1966.

- Revisar los sistemas contables, procedimientos administrativos y mecanismos de control del Banco Minero de Bolivia, sugiriendo a la Segunda Subcomisión, las medidas que sean necesarias.

Las labores de la Segunda Subcomisión serán:

- Gestionar la obtención del necesario financiamiento que permita agilizar la comercialización de minerales.

- Formular al Directorio del Banco Minero de Bolivia, las recomendaciones que sean necesarias en materia administrativa, financiera, control de operaciones, rescate, comercialización y exportación de minerales.

- Informar mensualmente al Consejo Nacional de Desarrollo y Estabilización sobre los resultados de su labor.
...
- A seis meses plazo con el interés del 8% anual, para el rescate de minerales.

- A dos años plazo con el interés del 8% anual, para el financiamiento de las exportaciones de minerales, hasta el 80% de su valor, en forma rotativa, que incluye los pagos de fletes, regalías y gastos de despacho. Durante este tiempo el Banco Minero de Bolivia, constituirá su propio capital de operaciones con las utilidades provenientes de la comercialización de un mayor volumen de minerales.

ARTÍCULO 9.-La utilización de la línea de crédito estará sujeta a las siguientes modalidades:

- Por el adelanto a los productores mineros contra entrega de minerales en las bodegas del Banco Minero, que no será mayor al 50% del valor probable del mineral, y por el importe líquido de las liquidaciones definitivas de compra, el Banco Minero de Bolivia girará los correspondientes cheques contra la línea de crédito del Banco Central de Bolivia, a la orden de los productores y acompañando copia de la liquidación provisional o definitiva, debidamente suscrita. Estos pagos se efectuarán por el Banco Central de Bolivia, solamente cuando el Banco Minero de Bolivia no disponga de fondos propios.

- Tan pronto como se efectúe el embarque de un conjunto de minerales para la exportación, el Banco Minero de Bolivia girará una letra de cambio a la vista, a cargo de sus compradores, por el 80% del valor del mineral embarcado y la entregará al Banco Central de Bolivia, juntamente con una copia de los documentos de embarque, de la liquidación provisional de venta y de una orden irrevocable y escrita a sus compradores, instruyéndoles pagar directamente al Banco Central de Bolivia, tanto el valor de la letra girada, como el saldo del 20% del valor del mineral exportado.

- Por cada embarque efectuado, el Banco Minero de Bolivia deberá certificar ante el Banco Central de Bolivia, que lotes de minerales han sido utilizados en la conjuntación, para efectos de aplicar los pagos que se reciban de los compradores a los correspondientes créditos utilizados.

- El pago de fletes a los porteadores, regalías a la Aduana y comisiones y gastos a los agentes despachadores, se efectuará igualmente con cheques contra la línea de crédito, acompañados de las respectivas facturas, planillas y pólizas, visadas por el Banco Minero de Bolivia, dentro del 80% citado en el inciso b) del artículo 8°.

- La formación de conjuntos exportables por parte del Banco Minero de Bolivia, no podrá efectuarse en más de 30 días de la fecha de la liquidación definiitva de los minerales comprados, salvo casos justificados, ni dicha liquidación definitiva se efectuará en más de 15 días de la fecha en que se haya concedido el adelanto al productor minero.

- El Banco Minero de Bolivia, a tiempo de otorgar el adelanto, notificará al productor para que éste presencie el pesaje, muestreo y ensaye de sus minerales, dentro de los 15 días siguientes. En el caso deque el interesado no se hiciera presente, el Banco Minero de Bolivia, queda facultado para efectuar la liquidación definitiva de la compra, girando el respectivo cheque por el importe líquido a la orden del vendedor.
